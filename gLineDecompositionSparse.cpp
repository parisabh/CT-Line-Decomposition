...
#include<math.h>
#include "lbfgsb.h"
#include "JacFSparse.h"
/* Computational routine*/

void gLineDecompositionSparse(double bin1,double bin2,double bin3,double bin4,double bin5,
double bin6,double bin7,double bin8,double bin9,double bin10, double x[12],double * R)
{
    integer i__1;
    /* Local variables */
    static double f, *g;
   ...
   // static double x[5];
    //Necessary constants
    static double B [12][100];
    static double Weight[10][100];
    FILE *myFile;
   // myFile= fopen("Bjuly.txt", "r"); // 10 by 100 Wbrute
    myFile= fopen("FSparse.txt", "r"); // 5 by 100 normalized PEC
    FILE *myFile2;
    ...
    static double l[12];
    static integer m, n;
    static double u[12], t1, t2, wa[43251];
    static integer nbd[12], iwa[3072];
/*     static char task[60]; */
...
R=mxGetPr(plhs[0]);
gLineDecompositionSparse(*bin1,*bin2,*bin3,*bin4,*bin5,*bin6,*bin7,*bin8,*bin9,*bin10,x0,R);
