...
double bin6,double bin7,double bin8,double bin9,double bin10, double x0, double x1, double x2, double x3,double x4,double * R)
{
    integer i__1;
    /* Local variables */
    static double f, *g;
   ...
   myFile= fopen("FPAC.txt", "r"); // 2 by 100 normalized PEC
    FILE *myFile2;
...
double * x0=mxGetPr(prhs[10]); double * x1=mxGetPr(prhs[10]);
double * x2=mxGetPr(prhs[11]); double * x3=mxGetPr(prhs[11]);
double * x4=mxGetPr(prhs[11]);
double * R;

plhs[0]=mxCreateDoubleMatrix(1,1,mxREAL);
R=mxGetPr(plhs[0]);
gLineDecompositionPCA(*bin1,*bin2,*bin3,*bin4,*bin5,*bin6,*bin7,*bin8,*bin9,*bin10,*x0,*x1,*x2,*x3,*x4,R);
