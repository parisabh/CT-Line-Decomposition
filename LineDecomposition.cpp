...
void LineDecomposition(double bin1,double bin2,double bin3,double bin4,double bin5,
double bin6,double bin7,double bin8,double bin9,double bin10, double x[10], double * R)
{
    integer i__1;
    /* Local variables */
    static double f, *g;
    ...
    g=&gg;
    //Necessary constants
    static double B [10][100];
    static double Weight[10][100];
    FILE *myFile;
    myFile= fopen("Bjuly.txt", "r");
    FILE *myFile2;
    ...
    static double l[10];
    static integer m, n;
    static double u[10], t1, t2, wa[43251];
    static integer nbd[10], iwa[3072];
/*     static char task[60]; */
...
double * x=mxGetPr(prhs[10]);
double * R;

plhs[0]=mxCreateDoubleMatrix(10,1,mxREAL);
R=mxGetPr(plhs[0]);
LineDecomposition(*bin1,*bin2,*bin3,*bin4,*bin5,*bin6,*bin7,*bin8,*bin9,*bin10,x,R);
